...
(function() { # can avoid using eHapsCurrent_tc and gammas in genProbs calculation
...
(function() { # can avoid inflating fhb_t using eHapsCurrent_tc to make eMatRead_t
...
(function() { # profile using riyan fish data

    { message("Skipped: ", "speed test"); return(invisible(NULL)) }
...
(function() { # profile using HRC data
    ...
    if (1 == 0) {
        ...
        { message("Skipped: ", "woo"); return(invisible(NULL)) }
...
(function() { # profile genProbs making with or without eHapsCurrent_tc

    { message("Skipped: ", "test"); return(invisible(NULL)) }
