...
(function() { # QUILT can impute a few samples with NIPT, w/wo IRC, w/wo regular vs mspbwt vs zilong
  ...
  for(nipt in c(TRUE, FALSE)) {
    ...
    for(impute_rare_common in c(TRUE, FALSE)) {
      ...
      for(i_method in 1:2) {
        ...
        print(paste0("nipt = ", nipt, ", mspbwt = ", use_mspbwt, ", impute_rare_common = ", impute_rare_common, ", i_method = ", i_method, ", ", date()))
