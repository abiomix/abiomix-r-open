...
(function() { # can identify all 1 eMatRead_t cols, and get 0-based indices of non-1 entries otherwise
...
(function() { # subtraction approach works
...
(function() { # can skip reads and more efficiently calculate probabilities for gibbs sampling, specifically diploid
