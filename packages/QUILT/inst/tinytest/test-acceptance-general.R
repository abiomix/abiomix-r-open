...
(function() { # QUILT can impute a few samples in a standard way, using a small panel, with or without a genetic map
...
(function() { # QUILT can impute entire chromosomes
...
(function() { # QUILT can use all combinations of posfile, genfile and phasfile in the right way, with or without buffers
    ...
    for(i_buffer in 1:2) {
        ...
        for(i in 1:4) {
            ...
            output <- capture.output(QUILT(outputdir = outputdir, chr = data_package$chr, regionStart = regionStart, regionEnd = regionEnd, buffer = buffer, bamlist = data_package$bamlist, posfile = posfile, genfile = genfile, phasefile = phasefile, nGibbsSamples = 3), type = "message")
...
(function() { # QUILT can impute in one step
...
(function() { # QUILT can use specified or inferred nMaxDH
...
(function() { # QUILT can save or not save prepared reference data
...
(function() { # QUILT can impute samples with very few reads
...
(function() { # QUILT can use or not use eigen to impute
...
(function() { # QUILT can plot plots

    { message("Skipped: ", "disable for now"); return(invisible(NULL)) }
