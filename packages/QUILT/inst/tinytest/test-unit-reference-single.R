...
(function() { # can bound make_gl_from_u_bq
...
(function() { #  can select good haps properly
...
(function() { # can quickly in cpp get positions greater than certain value
...
(function() { # can do simple binary search
...
(function() { # can build necessary components from make_rhb_t_equality
...
(function() { # can avoid normalizing alphaHat and betaHat throughout forward algorithm, but recover correct gamma when asked, as well as dosages
...
(function() { # can run a single gl sample through reference haplotypes quickly with grid of 32
...
(function() { # profile
    ...
    { message("Skipped: ", "for profiling"); return(invisible(NULL)) }
...
(function() { # prototype idea of classes for faster alphaHat

    { message("Skipped: ", "not sure this is the right idea"); return(invisible(NULL)) }
