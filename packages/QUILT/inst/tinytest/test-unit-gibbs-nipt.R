...
(function() { # read set probabilities agree

    { message("Skipped: ", "to restore in future"); return(invisible(NULL)) }
...
(function() { # can re-label read labels where entirely changing is much better
...
(function() { # gibbs-nipt normalization scheme makes sense
...
(function() { # gibbs-nipt works in R and CPP and gives the same thing
...
(function() { # gibbs-nipt initializing iteratively produces same alpha and beta, and same in R as Rcpp
...
(function() { # can do multiple gibbs samplings
...
(function() { # label values do not suck
...
(function() { # averaging logic makes sense
...
if(1 == 0) {
(function() { # properly simplified gibbs-nipt forward and backward

    ## OK - promising enough!
    { message("Skipped: ", "wip"); return(invisible(NULL)) }
    ff <- 0.2
    test_package <- make_fb_test_package(
        K = 20,
        nReads = 50,
...
(function() { # gibbs-nipt works with S > 1
