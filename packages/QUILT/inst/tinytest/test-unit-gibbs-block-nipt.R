...
(function() { # can do get_log_p_H_class in R and Rcpp
...
(function() { # can do get_log_p_H_class2 in R and Rcpp
...
(function() { # can confirm that can calculate read label probabilities using H class in R and Rcpp
...
(function() { # idea of one_based_swap can carry over between R and Rcpp
...
(function() { # can do single quantile hack in cpp using arma
    x <- runif(1000)
    q <- 0.90
...
(function() { # can reconfigure blocked_snps
...
(function() { # can perform block gibbs when ff is 0
...
(function() { # can perform block gibbs
...
(function() { # can perform ff shard block gibbs including at all sites
