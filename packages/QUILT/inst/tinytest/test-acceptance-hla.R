...
(function() { # can run acceptance test on HLA
    ...
    if (!file.exists(file_quilt_hla_specific_haplotypes(ref_dir, hla_gene))) {
        { message("Skipped: ", "input data not available to test QUILT HLA"); return(invisible(NULL)) }
    }
    ...
    ## source("~/proj/QUILT/QUILT/inst/tinytest/test-acceptance-hla.R")
