...
(function() { # QUILT can impute a few samples in a standard way using either normal, or mspbwt approaches, also using rare common idea
  ...
  for(impute_rare_common in c(TRUE, FALSE)) {
    ...
    ## this is the different methods: mspbwt A, none, mspbwt B
    for(i_method in 1:2) {
