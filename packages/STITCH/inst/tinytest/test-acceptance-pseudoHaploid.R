...
(function() { # STITCH pseudoHaploid works under default parameters
...
(function() { # STITCH pseudoHaploid works under default parameters for S > 1
...
(function() { # STITCH pseudoHaploid works with outputSNPBlockSize
...
(function() { # STITCH pseudoHaploid works with switchModelIteration
...
(function() { # STITCH pseudoHaploid works with a single sample and two cores
