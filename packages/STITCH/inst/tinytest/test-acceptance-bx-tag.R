...
(function() { # can get bx tag into R
...
(function() { # can make sampleReadsRaw incorporate bx tag properly for complicated example
...
(function() { # can resize appropriately
