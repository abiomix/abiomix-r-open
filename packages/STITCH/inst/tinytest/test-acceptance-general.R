...
(function() { # STITCH diploid works under default parameters
...
(function() { # STITCH diploid works with multiple cores
...
(function() { # STITCH diploid works with completely split reads
...
(function() { # STITCH diploid works with genfile with entirely NA columns
...
(function() { # STITCH diploid works under default parameters when outputdir has a space or a tilda in it
...
(function() { # STITCH diploid works under default parameters when tempdir is relative
...
(function() { # STITCH diploid works under default parameters with nCores = 40 and N = 25
...
(function() { # STITCH diploid works under default parameters with N = 25 and nCores = 40
...
(function() { # STITCH diploid works with regionStart, regionEnd and buffer
...
(function() { # STITCH diploid works under default parameters using CRAM files
...
(function() { # STITCH with generateInputOnly actually only generates input
...
(function() { # STITCH can get sample names from a file
...
(function() { # STITCH works in a situation with grid, buffer, outputBlockSize, etc
...
(function() { # STITCH can generate interim plots
...
(function() { # STITCH works when using a tempdir for writing useTempdirWhileWriting
...
(function() { # STITCH can rebundle inputs
...
(function() { # STITCH can avoid rebundling inputs when only one bundle
