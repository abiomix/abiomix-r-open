(function() { # can refill simple
    ...
    for(gridWindowSize in c(NA, 3)) {
        ...
        ## make one bad hapSum
        gammaSum_tc_new <- STITCH:::refillSimple(
            hapSum_tc = hapSum_tc,
...
(function() { # can refill simple again
...
(function() { # can refill simple with grid for only part of hapSum
