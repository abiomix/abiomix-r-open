...
## mostly for QUILT
(function() { # can load and split into rare and common
    ...
    outR <- STITCH:::R_get_hap_info_from_vcf(
        vcffile = vcffile,
        af_cutoff = af_cutoff,
        region = region
    )
...
(function() { # speed check
    ...
    { message("Skipped: ", "is speed check"); return(invisible(NULL)) }
