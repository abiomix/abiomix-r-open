...
(function() { # STITCH throws an error when no SNPs in region to impute, or if fewer than 2 SNPs to impute
...
(function() { # STITCH works with very few SNPs in central region and buffer
