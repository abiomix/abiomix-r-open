source("helper-output-formats.R", local = TRUE)
...
(function() { # STITCH can initialize with reference data

    for(output_format in stitch_test_output_formats()) {
...
(function() { # STITCH throws an error if reference panel information not sized properly
...
(function() { # STITCH can initialize with reference data for S > 1
...
(function() { # STITCH can initialize with reference data including genetic map, and that data is used precisely
...
(function() { # STITCH can initialize with reference data with three sizes of K vs number of haps
...
(function() { # STITCH can initialize with reference data with defined regionStart and regionEnd
...
(function() { # STITCH can initialize with reference sample file, without population specified
...
(function() { # STITCH can initialize with reference data for certain populations
...
(function() { # STITCH can initialize with reference data for certain populations for defined regionStart and regionEnd
...
(function() { # STITCH can initialize with reference data for certain populations for defined regionStart and regionEnd with non-perfect overlap of SNPs
...
(function() { # STITCH can initialize on chromosome X with reference data with defined regionStart and regionEnd
...
(function() { # STITCH can initialize on chromosome X with reference data for certain populations
...
(function() { # STITCH can initialize on chromosome X with reference data for certain populations for defined regionStart and regionEnd
...
(function() { # STITCH can impute with reference panels with only 1 iteration if the initialize with reference data
...
(function() { # STITCH errors if niterations=1 with reference panel and posfile is not the same as reference legend
...
(function() { # STITCH can initialize with reference data with snap to grid
