...
(function() { # STITCH diploid works with snap to grid
...
(function() { # STITCH diploid works with snap to grid with a buffer
...
(function() { # STITCH pseudoHaploid works with grid
...
(function() { # STITCH diploid works with snap to grid with downsampleToCov
